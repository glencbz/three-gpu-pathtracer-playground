// Copied from https://github.com/gkjohnson/three-gpu-pathtracer/blob/main/example/areaLight.js
import * as THREE from 'three';
import { FullScreenQuad } from 'three/examples/jsm/postprocessing/Pass.js';
import { OrbitControls } from 'three/examples/jsm/controls/OrbitControls.js';
// Avoid web workers by using PathTracingSceneGenerator instead of PathTracingSceneWorker
import { PathTracingRenderer, PathTracingSceneGenerator, PhysicalPathTracingMaterial, PhysicalCamera, ShapedAreaLight  } from 'three-gpu-pathtracer';
...
async function init() {
	...
	const result = generator.generate( group );
  sceneInfo = result;
